...
def create_prompt_and_query(pdf_text, user_query):
    template = "Based on the following document: {document_text}\n\nAnswer this question: {query}"
    ...
    formatted_prompt = prompt_template.format(document_text=pdf_text, query=user_query)
